...
export const defaultObjectStoreName = "mst"

export const getIDRaw = <T>(value: T) => {
  if (value instanceof Uint8Array) {
    return value
  } else {
    throw new TypeError("unexpected value - provide a getID for non-Uint8Array values")
  }
}
...
export const equalNodes = <T>(a: Node<T>, b: Node<T>) => a.level === b.level && equalKeys(a.key, b.key) && equalArrays(a.hash, b.hash)
